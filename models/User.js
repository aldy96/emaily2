...
mongoose.model('users', userSchema); //membuat model dan mencocokan dengan yang ada di mongodb, load Schema into mongoose, akan otomatis membuat collection jika tidak ada di mongodb