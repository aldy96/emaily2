...
passport.use(
    new GoogleStrategy( //function kemudian kita berikan clientID object sebagai parameter
    {
        ...
        proxy: true, //in production, when we request to heroku, it will get into heroku proxy, and proxy is not trusted, so we add this code to tell the google strategy "hey it's fine, it trusted"
    }, 
